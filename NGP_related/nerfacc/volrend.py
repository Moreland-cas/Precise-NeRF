...
def rendering(
    ...
    # rendering options
    render_bkgd: Optional[Tensor] = None, # 3
...
def render_weight_from_density(
    ...
    trans, alphas = render_transmittance_from_density(
        t_starts, t_ends, sigmas, packed_info, ray_indices, n_rays, prefix_trans, version
    )
    weights = trans * alphas
