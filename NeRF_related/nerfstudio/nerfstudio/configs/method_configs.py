...
method_configs["instant-ngp-bounded"] = TrainerConfig(
    ...
    pipeline=DynamicBatchPipelineConfig(
        ...
        datamanager=VanillaDataManagerConfig(dataparser=NsvfDataParserConfig(), train_num_rays_per_batch=8192),
...
method_configs["vanilla-nerf"] = TrainerConfig(
    ...
    pipeline=VanillaPipelineConfig(
        datamanager=VanillaDataManagerConfig(
            dataparser=BlenderDataParserConfig(alpha_color="white"),
            # dataparser=NsvfDataParserConfig(alpha_color="white"),
            train_num_rays_per_batch=4096
        ),
        model=VanillaModelConfig(
            enable_collider=True,
            collider_params = {"near_plane": 2., "far_plane": 6.0},
            _target=NeRFModel,
            background_color="white",
